...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="adminhome.php"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			...
			<div class="row">
				...
				<div class="col-xs-4 col-md-4 col-lg-4 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-toggle-off color-blue"></em>
				...
				<a href="recyclerdetails.php">
				<div class="col-xs-4 col-md-4 col-lg-4 no-padding">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-recycle color-orange"></em>
							<div class="large">52</div>
							<div class="text-muted">Recycler</div>
						</div>
					</div>
				</div>
				</a>
