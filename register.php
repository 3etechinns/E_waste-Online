			...
			<form class="form-horizontal" role="form" method="post" action="#">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Your Phone *" name="Mobile" id="Mobile" onchange="vari(this.value)" required pattern="[0-9]{10}" title="Please enter valid 10 digit phone number" value="<?php echo $Mobile; ?>" required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btnRegister"  id="btnSubmit" value="register" name="register">Sign Up</button>
                    </div>
                    </div>
                </div>
				</form>
