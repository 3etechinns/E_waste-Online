...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group">
		...
		<a href="userdetails.php"><button type="button" class="btn btn-primary btn-block">Back</button></a>
    </div>
    </form>
</article>
</div> <!-- card.// -->
...
if(isset($_POST['profile']))
	{
		...
		$sql = "UPDATE users SET F_name='$F_name',L_name='$L_name',P_code='$P_code',Address='$Address' WHERE User_id='$id'";
		$r = mysqli_query($db,$sql);
		echo $r;
		echo "<script type='text/javascript'>alert('Profile Update Sucessfully');window.location='userdetails.php';</script>";
	}
?>