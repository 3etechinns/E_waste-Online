    ...
    <div id="wrapper" style="margin-left:250px;">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Delete Recycler </h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                <?php
                                                $id=$_GET['id'];
                                                $sql = "SELECT * FROM recycler where Recycler_id='$id'";
                                                $result = $db->query($sql); 
                                   ...
                                   echo '<input type="submit"  value="Delete" name = "Delete" class="btn btn-danger" ></a>';
                                                ...
                                                echo ' ';
                              echo '<a href="recyclerdetails.php")>  <button type="button"  name = "Back" class="btn btn-primary" >Back</button>   </a>';
...
{
    $sql = "Delete from recycler where Recycler_id='$id'";
    $r = mysqli_query($db,$sql);
    echo $r;
    echo "<script type='text/javascript'>alert('Record Delete Sucessfully');window.location='recyclerdetails.php'</script>";
}
?>