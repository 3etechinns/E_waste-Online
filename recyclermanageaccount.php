<?php
	...
	$Mobile=$_SESSION['rec'];
	$query = "SELECT * from recycler where Mobile = '$Mobile'";
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="recyclerhome.php">Home
...
if(isset($_POST['profile']))
	{
		...
		$sql = "UPDATE recycler SET F_name='$F_name',L_name='$L_name',P_code='$P_code',Address='$Address' WHERE Mobile='$Mobile'";
		$r = mysqli_query($db,$sql);
		echo $r;
		echo "<script type='text/javascript'>alert('Profile Update Sucessfully');window.location='recyclerhome.php'</script>";
	}
	if(isset($_POST['change_password']))
	{
		...
		{
		$sql = "UPDATE recycler SET Password='$Password1' WHERE Mobile='$Mobile'";
		$r = mysqli_query($db,$sql);
		echo $r;
		echo "<script type='text/javascript'>alert('Password Change Sucessfully');</script>";
