...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="recyclerdetails.php"><em class="fa fa-recycle">&nbsp;</em>Recycler</a></li>
    ...
    <div id="wrapper" style="margin-left:250px;">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Recycler Master</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="panel-body">
                                   ...
                                   echo '<a href="editrecycler.php?id=',$id,'")">  <button type="button"  name = "Edit" class="btn btn-primary" >Edit</button>   </a>';

                                                echo ' ';
                              echo '<a href="deleterecycler.php?id=',$id,'")">  <button type="button"  name = "delete" class="btn btn-danger" >Delete</button>   </a>';
