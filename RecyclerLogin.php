...
<div class="containers">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				 <form class="login" method="post" action="Loginrecyclerserver.php">
					<div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-user"></i></span>
						</div>
						<input type="text" class="form-control" name="mobile" placeholder="Mobile Number" required pattern="[0-9]{10}" title="Please enter valid 10 digit phone number" >
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<a href="RecyclerRegister.php">Sign Up</a>
				</div>
				<div class="d-flex justify-content-center">
					<a href="rforgot-password.php">Forgot your password?</a>
				</div>
			</div>
		</div>
	</div>
