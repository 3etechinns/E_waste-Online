        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="<?php echo 'myproductview.php?id=',$p_id,'' ?>">Home
...
if(isset($_POST['addpro']))
{
    ...
    $r=mysqli_query($db,$sql);
        echo $r;
		echo "<script type='text/javascript'>alert('Edit product Sucessfully');window.location='myproduct.php';</script>";
}
?>