  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="adminproductview.php">Admin</a>
			</div>
		</div><!-- /.container-fluid -->
</nav>
      ...
      <div class="col-lg-9">
        ...
        <img class="mySlides" src="<?php echo $row['photo4'];?>" width="600" height="400">
         ...
         <button class="w3-button w3-black w3-display-right" onclick="plusDivs(1)">&#10095;</button>
          ...
          <?php echo '<a href="admineditproduct.php?id=',$id,'")">' ?><button type="button" class="btn btn-primary btn-block">Edit Product</button><?php echo '</a>' ?><br>
          <?php echo '<a href="admindeleteproduct.php?id=',$id,'")">' ?><button type="button" class="btn btn-danger btn-block">Delete Product</button><?php echo '</a>' ?>
        </div>
